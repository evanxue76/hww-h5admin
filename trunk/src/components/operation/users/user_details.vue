    ...
    <el-dialog title="开通服务" :visible.sync="dialogFormVisible" :before-close="cancel">
      <el-form :model="form">
        <el-form-item label="服务名称" :label-width="formLabelWidth">
          <el-select v-model="form.packageId" placeholder="请选择套餐"  style=" margin-left: 60px;" @change="breakdown()">
      ...
      >
       <el-form :model="between">
        ...
        <el-form-item label="到期时间" :label-width="formLabelWidth">
          <el-radio v-model="between.termValidityStatus"   label="0" style="margin-left: 60px;">永久</el-radio>
          <div class="resources" style="margin-left: 60px;">
            <el-radio v-model="between.termValidityStatus"   label="1">指定时间</el-radio>
              <el-date-picker
