		...
		<div class="edit_doctor_content">
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :disabled="ruleForm.source==0">
				...
				<el-form-item label="医院等级" prop="hospitalGradeCode">
					<el-select v-model="ruleForm.hospitalGrade" @change="data=>set_hospital_change(data,'hospital_level_list','hospitalGrade','hospitalGradeType')"
	...
	export default {
		created() {
			...
			if (this.$route.params.row) {
				...
				console.log(54666666,this.$route.params.row)
			}
