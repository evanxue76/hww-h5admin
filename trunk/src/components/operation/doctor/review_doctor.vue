    ...
    <div class="edit_doctor_content">
      ...
      >
        ...
        <el-form-item label="姓名">
          <el-input v-model="ruleForm.doctorName" maxlength="10" :disabled="ruleForm.source==0"></el-input>
        </el-form-item>
        <!-- prop="mobile" -->
        <el-form-item label="手机号码">
          <el-input v-model="ruleForm.mobile" maxlength="11" :disabled="ruleForm.source==0"></el-input>
        </el-form-item>
        <!-- prop="idCard" -->
        <!-- prop="hospitalName" -->
        <el-form-item label="所属医院">
          <el-input v-model="ruleForm.hospitalName" maxlength="30" :disabled="ruleForm.source==0"></el-input>
        </el-form-item>
        ...
        <div class="tudan-flex">
          ...
          <!-- prop="parentDoctorId" -->
          <el-form-item label="上级医生" v-if="ruleForm.isAssistant===1">
        ...
        <el-form-item label="身份证" prop="idCard">
          <el-input v-model="ruleForm.idCard" maxlength="18" :disabled="ruleForm.source==0"></el-input>
        </el-form-item>
        <div class="tudan-flex">
          <el-form-item>
            <el-upload
              :class="{upDisabled:ruleForm.source===0}"
              :disabled="ruleForm.source==0"
              ref="sfz1"
        ...
        <el-form-item>
          ...
          <el-input
            v-model="ruleForm.practisingPhysicianNo"
            :disabled="ruleForm.source==0"
            v-if="zg_active"
          ></el-input>
          <el-input
            v-model="ruleForm.professionalTechnologyNo"
            :disabled="ruleForm.source==0"
            v-if="!zg_active"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <span>医师执业证书编号</span>
          <el-input
            v-model="ruleForm.certificatePracticeNo"
            :disabled="ruleForm.source==0"
            maxlength="18"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item style="width: 600px;">
          <el-button
            type="success"
            v-if="ruleForm.assistantStutas==0"
...
export default {
  created() {
    ...
    console.log(65466666,this.doctorId)
  ...
  methods: {
  	docDivideInto(){
      console.log(this.ruleForm.docDivideInto)
...
//        this.input= i.divideInto;
    ...
    async get_doctor_info(id) {
      ...
      try {
        ...
        if (res.data.respHead.respCode === "000") {
          ...
          if (this.ruleForm.channelNo == '' || this.ruleForm.channelNo == '0') {
          ...
          this.majorName = this.ruleForm.majorName;
      ...
      try {
        ...
        if (res.data.respHead.respCode === "000") {
          if (id) {
            ...
            if (this.majorName) {
              this.ruleForm.majorName = this.majorName;
              this.majorName = "";
            }
          } else {
            res.data.body.data.forEach(i => {
    ...
    submitForm(formName, type) {
      ...
      if (type) {
        params.body.assistantStutas = type;
        this.ruleForm.isPlatForm = '';
      }else{
      	this.ruleForm.isPlatForm = 1;
      }
      params.body.id = this.ruleForm.id;
    ...
    opening(row){
    	...
    	if (row.serviceType != 8) {
	    	if (this.ruleForm.academicTitleId === '' || this.ruleForm.isAssistant === '') {
	    		this.$message({
	          showClose: true,
	          message: '开通心电报告解读服务请完善 基本信息!',
	          type: 'error',
	          duration: 0
	        });
	        return
	    	...
	    	if (this.ruleForm.practisingPhysicianNo == '' && this.ruleForm.professionalTechnologyNo == '') {
	    		this.$message({
	          showClose: true,
	          message: '开通心电报告解读服务请完善 执业医师资格证书!',
	          type: 'error',
	          duration: 0
	        });
	        return
