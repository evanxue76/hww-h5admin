          ...
          <el-table :data="tableData"  border  >
            ...
            <el-table-column label="SN" prop="text"  min-width="100%" >
              <template slot-scope="scope">
                <el-input  style="width: 180px;"   v-model="scope.row.text" maxlength="15"   clearable ></el-input>
              </template>
            </el-table-column>
...
//		}
		...
		if(this.searchData.price !="" ||this.searchData.helowinPeople != ""  || this.sn != ""){
			let Url = "",
			  params = {
			    reqHead: {
			...
			try {
			  ...
			  if (
			    ...
			    this.loading = false;
			      ...
			      name: "repeats",
			      query: {
			        cf: res.data.body.data
			      },
				   
			    });
				
				//  console.log( baseUrl.developmentUrl.host1+'/dwadmin/home/repeats')
				//    var param  =encodeURI(res.data.body.data)
				//  window.open('http://192.168.1.93:8888/dwadmin/home/repeats?vehicleId='+ param, '_blank');
				//   localStorage.getItem("mangguo",JSON.stringify(res.data.body.data))
